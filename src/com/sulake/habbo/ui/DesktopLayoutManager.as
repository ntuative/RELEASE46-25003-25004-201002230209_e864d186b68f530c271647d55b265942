package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1613:String = "room_widget";
      
      private const const_1076:String = "room_view";
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_51.getChildByTag(const_1076) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_51.findChildByTag(const_1076) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_658;
               _loc2_.width = var_51.desktop.width - var_658;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_658;
               _loc2_.height = var_51.desktop.height - var_658;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_51.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_51.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_327,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1613) == 0)
            {
