package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_98:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_498,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_511];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_511:
      ...
      {
         return [RoomSessionDoorbellEvent.const_98,RoomSessionDoorbellEvent.const_127,RoomSessionDoorbellEvent.const_53];
      }
