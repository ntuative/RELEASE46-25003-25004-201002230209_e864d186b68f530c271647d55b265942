package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_512:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_510 != null)
         {
            ...
            {
               _loc2_ = var_510.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_510.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_730.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_278:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_510.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_730.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_647,RoomWidgetChatSelectAvatarMessage.const_644];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_647:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_137,_container.roomSession,0,"Version 25003-25004-201002230141");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_644:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_905 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_905);
            }
            if(var_512 == null)
            {
               var_511.x = 0;
               var_511.y = 0;
               var_511.z = 0;
               var_512 = _loc4_.getScreenPoint(var_511);
               var_905 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_511.x = 0;
            var_511.y = 0;
            var_511.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_511);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_512.x || _loc8_.y != var_512.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_512,_loc5_));
