package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               ...
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_144,onPetInfo);
         ...
         if(false)
         {
            ...
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_144,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_532);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_795);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_907);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_278)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_376)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_857)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_571);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_220)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_701);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1351;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_835;
                  }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_701);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_698);
         _loc1_.push(RoomWidgetFurniActionMessage.const_724);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_730);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_634);
         _loc1_.push(RoomWidgetUserActionMessage.const_349);
         _loc1_.push(RoomWidgetUserActionMessage.const_534);
         _loc1_.push(RoomWidgetUserActionMessage.const_531);
         _loc1_.push(RoomWidgetUserActionMessage.const_1378);
         _loc1_.push(RoomWidgetPetCommandMessage.const_584);
         _loc1_.push(RoomWidgetPetCommandMessage.const_718);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_349)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_559:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_861,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_531:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_698:
            ...
            case RoomWidgetUserActionMessage.const_389:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_730:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_634:
               ...
               break;
            case RoomWidgetUserActionMessage.const_349:
