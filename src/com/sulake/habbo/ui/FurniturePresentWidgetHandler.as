package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomSessionPresentEvent.const_250];
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_668,RoomWidgetPresentOpenMessage.const_627,RoomWidgetPresentOpenedMessage.const_1143];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(_container != null && false && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_250:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_78:
                           if(_loc3_ != null && _loc3_.name == const_182)
                           {
                        ...
                        case ProductTypeEnum.const_362:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_371,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_668:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_145 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_130);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
