package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1404:OpenedToWebPopup;
      
      private var var_757:IAvatarRenderManager;
      ...
      private var var_1405:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_785:FriendRequests;
      
      private var var_1661:int;
      
      var var_13:FriendCategories;
      
      private var var_1787:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_786:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1787 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1405 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_785.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_785.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_370.findTab(FriendListTab.const_79).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_785 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_961,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_403,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_454)
         {
            var_454 = new Timer(120000);
            var_454.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_454.start();
         }
         getBuddyRequests();
         registerListeners();
         var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_454.stop();
            var_454.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_454 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_126)
         {
            var_126.release(new IIDHabboMessenger());
            var_126 = null;
         }
         if(var_176)
         {
         ...
         if(var_757)
         {
            var_757.release(new IIDAvatarRenderManager());
            var_757 = null;
         }
         if(var_786)
         {
            var_786.release(new IIDHabboNotifications());
            var_786 = null;
         }
         if(var_184)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_280));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1405.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function get method_2() : FriendListLookAndFeel
      {
         return var_1787;
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_785.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_370.findTab(FriendListTab.const_79);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_757.createAvatarImage(param1,AvatarScaleType.const_97);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_785.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_370.findTab(FriendListTab.const_79);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_757 = param2 as IAvatarRenderManager;
      ...
      {
         var_786 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1404 == null)
         {
            var_1404 = new OpenedToWebPopup(this);
         }
         var_1404.show(x,y);
      }
