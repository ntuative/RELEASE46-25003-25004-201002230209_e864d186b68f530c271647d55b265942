package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1231 != "")
         {
            friendList.refreshText(param1,"name_text_online",var_655,var_1231);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",var_655,var_1450);
         }
         friendList.refreshText(param1,"name_text_offline",!var_655,var_1450);
         friendList.refreshText(param1,"motto_text",var_655,var_1894);
         friendList.refreshButton(param1,"offline",!var_655,null,0);
         if(var_655)
         {
            refreshFigure(param1,var_1895);
