package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_729:String = "bg";
       
      
      private var var_1937:IContainerButtonWindow;
      
      private var var_1936:IContainerButtonWindow;
      
      private var var_1938:IContainerButtonWindow;
      
      private var var_1939:IContainerButtonWindow;
      ...
      {
         var_1936 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1938 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1937 = initButton("room_invite",onInviteButtonClick,param1);
         var_1939 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_729);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(param2.selected)
         {
            _loc4_.color = _friendList.method_2.getSelectedEntryBgColor();
         }
         ITextWindow(param2.view.findChildByName("name")).textColor = _friendList.method_2.getFriendTextColor(param2.selected);
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.method_2.getRowShadingColor(FriendListTab.const_82,param4);
         _loc6_.visible = true;
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_236)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_236 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1936,isEnableMinimailButton(_loc1_));
         setEnabled(var_1938,isEnableHomeButton(_loc1_));
         setEnabled(var_1937,isEnableInviteButton(_loc1_));
         setEnabled(var_1939,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_729);
         _loc7_.color = _friendList.method_2.getRowShadingColor(FriendListTab.const_82,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         return _friendList.method_2.getRowShadingColor(FriendListTab.const_82,param1);
      }
