package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_650 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_650.procedure = onSearchInput;
         var_650.addEventListener(WindowKeyboardEvent.const_143,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_47.getListItemAt(_loc1_).color = _friendList.method_2.getRowShadingColor(FriendListTab.const_289,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_650.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
