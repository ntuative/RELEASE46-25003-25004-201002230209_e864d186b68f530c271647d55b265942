package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function refreshTabText(param1:FriendListTab, param2:IWindowContainer) : void
      {
         ...
         _loc3_.textColor = _friendList.method_2.getTabTextColor(param1.newMessageArrived,param1.id);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_280);
         }
      }
