package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_237.length / const_287);
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         while(_loc3_ < var_237.length)
         {
            ...
            {
               var_237.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_913 + 1) * const_287,this.var_237.length);
      }
