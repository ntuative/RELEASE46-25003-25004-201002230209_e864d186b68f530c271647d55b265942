package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_770:int = 31536000;
      
      private static const const_768:int = 86400;
      
      private static const const_769:int = 3600;
      
      private static const const_767:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_767) + " mins ago";
         }
         if(param1 < 2 * const_768)
         {
            return Math.round(param1 / const_769) + " hours ago";
         }
         if(param1 < 2 * const_770)
         {
            return Math.round(param1 / const_768) + " days ago";
         }
         return Math.round(param1 / const_770) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_48,WindowTracker.const_854,_data.userId),_callerFrame,var_1013,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_839.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_48.getXmlWindow("user_info"));
            var_839.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new ModActionCtrl(var_48,_data.userId,_data.userName,var_1275),_callerFrame,var_1013,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new RoomVisitsCtrl(var_48,_data.userId),_callerFrame,var_1013,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.windowTracker.show(new SendMsgsCtrl(var_48,_data.userId,_data.userName,var_1275),_callerFrame,var_1013,false,true);
      }
