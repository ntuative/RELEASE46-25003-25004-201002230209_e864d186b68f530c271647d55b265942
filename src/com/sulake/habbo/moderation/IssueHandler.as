package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_108:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.releaseBundle(var_108.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc1_:XmlAsset = var_55.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         _window = var_55.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(_window == null)
         {
            return;
         }
         ...
         var_55.disableButton(var_55.initMsg.chatlogsPermission,_window,"show_chatlog");
         _loc2_ = _window.findChildByName("move_to_player_support");
         if(_loc2_ != null)
         {
            _loc2_.disable();
         }
         var _loc3_:IssueMessageData = var_108.getHighestPriorityIssue();
         var_372 = new UserInfoCtrl(_window,var_55,_loc3_.message);
         var_950 = new UserInfoCtrl(_window,var_55,_loc3_.message);
         var_372.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_108.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_950.load(_loc4_,var_108.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.closeBundle(var_108.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = var_55.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = var_55.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
         var _loc4_:Array = var_108.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_108.getHighestPriorityIssue().issueId;
         var_55.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_55,WindowTracker.const_892,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_55 != null && false && var_108 != null)
         {
            var_55.issueManager.removeHandler(var_108.id);
         }
         this.dispose();
      }
      ...
      {
         if(_window == null || var_55 == null || true)
         {
            return;
         }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_108.getHighestPriorityIssue();
            var_372 = new UserInfoCtrl(_window,var_55,_loc3_.message);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.closeBundle(var_108.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_55.issueManager.closeBundle(var_108.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = var_55.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = var_55.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
