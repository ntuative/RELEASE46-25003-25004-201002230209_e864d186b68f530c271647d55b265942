package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_963:String = "issue_bundle_open";
      
      public static const const_679:String = "issue_bundle_my";
      
      public static const const_801:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_136 = new Map();
         var_854 = new Map();
         var_577 = new IssueBrowser(this,var_55.windowManager,var_55.assets);
         var_686 = [];
         var_853 = [];
         var_1031 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1031.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in var_136)
         {
            ...
            {
               case const_963:
                  if(_loc4_.state == IssueMessageData.const_132)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_686 = var_686.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_854.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_854.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1277)
         {
            var_157.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_136)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_854.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_854.add(param1.issueId,_loc2_);
         ...
         if(var_686.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_132)
         {
            ...
            _loc8_ = var_853.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      {
         var _loc2_:* = var_1031.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_132 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_577 == null || !var_577.isOpen())
         {
            var_55.soundManager.playSound(HabboSoundTypesEnum.const_912);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_854.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_136.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
