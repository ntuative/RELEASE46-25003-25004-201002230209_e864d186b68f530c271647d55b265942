package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_860 = IWindowContainer(var_48.getXmlWindow("chatlog_roomheader"));
         var_861 = IWindowContainer(var_48.getXmlWindow("chatlog_chatline"));
         ...
         var_48.connection.send(var_1557);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_860.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_861.clone());
         _loc4_.color = var_1285[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
