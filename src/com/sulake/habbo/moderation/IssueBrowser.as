package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1575:IIssueBrowserView;
      
      private const const_1630:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1631:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1574:IIssueBrowserView;
      ...
      private var var_1573:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_357.view.width = var_235.container.width;
         var_357.view.height = var_235.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1632:
               if(var_1574 == null)
               {
                  var_1574 = new MyIssuesView(issueManager,this,var_235.container);
               }
               return var_1574;
            case const_1630:
               if(var_1575 == null)
               {
                  var_1575 = new OpenIssuesView(issueManager,this,var_235.container);
               }
               return var_1575;
            case const_1631:
               if(var_1573 == null)
               {
                  var_1573 = new PickedIssuesView(issueManager,this,var_235.container);
               }
               return var_1573;
            default:
               return null;
