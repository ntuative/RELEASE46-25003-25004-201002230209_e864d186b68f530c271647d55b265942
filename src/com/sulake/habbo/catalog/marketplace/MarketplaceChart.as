package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1084 + var_1084 / -var_2343 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_914 - var_914 / var_429 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_429).toString().length - 1);
         var_429 = Math.ceil(var_429 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_429.toString();
         _loc3_.draw(_loc6_);
         var_1084 = param1 - _loc6_.textWidth - 2;
         var_914 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_914);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_914 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1084,(param2 - var_914) / 2));
         return _loc3_;
      }
