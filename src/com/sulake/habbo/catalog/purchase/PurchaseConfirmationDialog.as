package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1633:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_912;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_912,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1541;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.method_11(_loc6_,ProductTypeEnum.const_74);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_663,var_79,var_1083);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_912);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_608[var_204]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_607[var_203]);
         _catalog.purchaseProductAsGift(var_663,var_79,var_1083,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_141:
               ...
               if(var_2233 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_237)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1633)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2233 = _loc3_.text;
               break;
            case WindowMouseEvent.const_48:
               showSuggestions(false);
               if(var_1354)
               ...
               break;
            case WindowKeyboardEvent.const_639:
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = var_79.productContainer.firstProduct;
