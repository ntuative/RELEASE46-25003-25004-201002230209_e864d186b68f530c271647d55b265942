package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1336:IProductData;
      ...
      {
         super();
         var_1335 = param1.productType;
         var_1333 = param1.furniClassId;
         var_1067 = param1.extraParam;
         var_1068 = param1.productCount;
         var_1334 = param1.expiration;
         var_1336 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_78:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1067);
               break;
