package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1468:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_663 != null)
         {
            _container.removeChild(var_663.window);
            var_663.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1468);
         var_663 = _loc5_;
      ...
      {
         return var_663.dispatchWidgetEvent(param1);
      }
