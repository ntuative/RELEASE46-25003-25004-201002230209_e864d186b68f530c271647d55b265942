package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_903:MarketPlaceOfferData;
      
      private const const_1425:int = 1;
      
      private const const_1629:int = 40;
      
      private var var_509:IWindowContainer;
      
      private const const_1424:int = 2;
      ...
      private const const_1628:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_509)
         {
            ...
            var_509 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_509)
         {
            return;
         ...
         updateStatusDisplay(const_1424,_loc2_.length);
         if(!var_425)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_555)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_509 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_509.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1425);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_424.length)
         {
            _loc4_ = 0;
         }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_904 >= var_555.length)
            {
               return true;
            }
            addListItem(var_555.getWithIndex(var_904));
            ++var_904;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_903.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_424));
            _loc7_.selection = 0;
         }
      }
