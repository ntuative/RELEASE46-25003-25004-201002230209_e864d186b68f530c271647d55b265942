package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1113 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_308 = null;
         for each(_loc1_ in var_1112)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1113) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_897.width,var_897.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_897 = _loc3_.content as BitmapData;
