package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1064:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1064 != null)
         {
            var_1064.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1063 != null)
         {
            var_1063.removeEventListener(WindowKeyboardEvent.const_143,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1064 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1064 != null)
         {
            var_1064.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1063 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1063 != null)
         {
            var_1063.addEventListener(WindowKeyboardEvent.const_143,windowKeyEventProcessor);
         }
      }
