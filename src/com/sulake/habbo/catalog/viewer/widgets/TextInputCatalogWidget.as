package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_937:ITextFieldWindow;
      ...
      {
         super.init();
         var_937 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_937 != null)
         {
            var_937.addEventListener(WindowKeyboardEvent.const_639,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_937.text));
      }
   }
}
