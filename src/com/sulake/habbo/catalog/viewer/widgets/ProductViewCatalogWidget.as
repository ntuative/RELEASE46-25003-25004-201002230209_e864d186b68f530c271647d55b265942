package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1270:IScrollbarWindow;
      
      protected var var_1359:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_574 != null)
         {
            var_574.visible = false;
            var_574.destroyGridItems();
         }
         if(var_1270 != null)
         {
            var_1270.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1316.text = "${" + _loc3_.name + "}";
            var_1317.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1316.text = "${" + _loc2_.localizationId + "}";
            var_1317.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_358:
                  _loc4_ = var_1271.clone();
                  if(var_574 != null)
                  {
                     var_574.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_574,var_1270,var_1359);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_212:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_293,AvatarAction.const_712);
                              _loc13_.appendAction(AvatarAction.const_535,_loc6_.productClassId);
      ...
      {
         var_1316 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1317 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1503 = new Point(var_86.x,var_86.y);
         var_574 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1270 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_574 == null)
         {
         ...
         var_1271 = _loc2_.content as BitmapData;
