package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1057:Number = 4285716709;
      ...
      private var var_1437:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1437 == 4294967295)
            {
               var_1437 = _loc1_.color;
            }
            _loc1_.color = const_1057;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1267;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1435) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_47 = navigator.catalog.windowManager.buildFromXML(var_1436) as IItemListWindow;
         if(var_47 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1334;
            }
         }
      }
