package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_155:int = 5;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1540)
         {
            case RecyclerStatusMessageEvent.const_1269:
               var_271 = const_347;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_954:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1348:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1540 != RecyclerStatusMessageEvent.const_954;
      }
      
      private function get statusActive() : Boolean
      {
         return var_271 != const_783;
      }
      ...
      {
         return active && var_271 == const_347;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_155)
            {
