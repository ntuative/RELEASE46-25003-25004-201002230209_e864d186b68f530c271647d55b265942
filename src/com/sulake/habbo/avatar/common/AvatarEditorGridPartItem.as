package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private var var_581:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         var_1052 = _loc6_.content as BitmapData;
         if(param3 == null)
         {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1528 = Math.max(var_1528,_loc7_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(var_581 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1052,var_1052.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function analyzeLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_859 + "_" + FigureData.const_261;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_859 + "_" + FigureData.const_261;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1527 && _loc2_.colorLayerIndex > 0)
               {
