package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_717:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_897 = _loc5_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_897.width,var_897.height,true,0);
            _loc4_ = var_897.clone();
            _loc4_.colorTransform(_loc4_.rect,var_717.colorTransform);
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(false)
               {
                  _loc5_.bitmap.copyPixels(var_1052,var_1052.rect,new Point(0,0),null,null,true);
               }
               else
               {
                  _loc5_.bitmap.copyPixels(var_1051,var_1051.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }
