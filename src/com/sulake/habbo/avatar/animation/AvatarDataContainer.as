package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1451,var_1452,var_1453,_alphaMultiplier);
         var_986 = generatePaletteMapForGrayscale(var_1869,var_1867);
      }
      
      public function get reds() : Array
      {
         return var_986.getValue("reds") as Array;
      }
      ...
      {
         return var_986.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_986.getValue("greens") as Array;
      }
      ...
      {
         return var_986.getValue("alphas") as Array;
      }
