package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_836:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_686)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_443)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_69.getParts(param1,(var_836 as AvatarImage).getFigure(),_loc6_,var_1234,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_69.getCanvas(var_187,var_1234);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1362[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_970 || _loc32_ == AvatarAction.const_684) && (_loc6_ == AvatarBodyPartType.const_299 || _loc6_ == AvatarBodyPartType.const_1261 || _loc6_ == AvatarBodyPartType.const_1212) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_187 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
