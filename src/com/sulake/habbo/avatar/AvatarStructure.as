package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_866:AvatarActionManager;
      ...
      private var var_2110:AvatarRenderManager;
      ...
      private var var_1525:AvatarStructureDownloadSet;
      
      private var var_699:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_1525 = new AvatarStructureDownloadSet();
         var_699 = new AnimationManager();
         var_698 = param4;
      ...
      {
         return var_866.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_866.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_866.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_699.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1155[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_866.getDefaultActionType();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc8_ = var_699.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_698 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_87:
               var_1525.add(new AvatarStructureDownload(var_155,_loc5_,var_493));
               break;
            case AvatarType.PET:
         }
         var_1525.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_699.getAnimation(param1);
      }
      ...
      {
         var_866 = new AvatarActionManager(var_155,var_698);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_155.hasAsset("dance" + _loc1_))
         {
            ...
            var_699.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      {
         return var_699.getLayerData(param1,param2,param3);
      }
      ...
      {
         return var_866.sortActions(param1);
      }
   }
}
