package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_904:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_1830:IStructureData;
      
      private var var_1425:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1425 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_1830.append(var_1425);
         dispatchEvent(new Event(AvatarStructureDownload.const_904));
      }
   }
}
