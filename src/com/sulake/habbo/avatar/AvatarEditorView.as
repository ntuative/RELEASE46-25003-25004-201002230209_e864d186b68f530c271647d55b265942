package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1501:Boolean = true;
      
      private var var_344:Timer;
      
      private var var_1502:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1356 == null)
         {
            ...
            var_1356 = var_11.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1582 == null)
         {
            _loc5_ = var_11.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1582 = var_11.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_480)
         {
            ...
            var_480 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_480.procedure = stripClubDialogEventProc;
            var_480.center();
         }
         else
         {
            var_480.visible = true;
            var_480.center();
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1502 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_713 = param1;
         var_1502.setSelected(var_1502.getSelectableByName(param1));
         _window.invalidate();
      }
