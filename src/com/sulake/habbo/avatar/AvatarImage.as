package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1046:String = AvatarSetType.const_37;
      
      private static const const_1044:String = "Default";
      
      private static const const_1047:int = 125;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_187 == null)
         {
            var_187 = AvatarScaleType.const_50;
         }
         ...
         var_132 = new AvatarImageCache(var_69,this,_assets,var_187);
         setDirection(const_1046,const_1045);
         var_186 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1139;
         if(param2 < AvatarDirectionAngle.const_1305)
         {
            param2 = AvatarDirectionAngle.const_525 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_525)
         {
            param2 -= NaN;
         }
         if(var_698 == AvatarType.PET && param1 == AvatarSetType.const_44)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_69.sortActions(var_186);
         if(_loc1_ == null)
         {
            var_539 = new Array(0,0,0);
         }
         else
         {
            var_539 = var_69.getCanvasOffsets(_loc1_,var_187,var_91);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1139 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_684)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_413)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_440)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_69.getPartColor(var_540,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_69.getCanvas(var_187,var_165.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_445);
            if(_loc10_ != null)
            {
               ...
               if(var_698 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_69.getParts(_loc9_,var_540,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_187 == AvatarScaleType.const_97)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_445);
                     _loc21_ = var_91;
                     _loc22_ = 1;
                     switch(var_91)
                     {
                     ...
                     _loc23_ = var_69.getPartActionOffset(getSubType(),var_187,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_69.getCanvas(var_187,var_165.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_445);
            if(_loc8_ != null)
            {
               ...
               if(var_698 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_69.getParts(_loc7_,var_540,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_445);
                     _loc19_ = var_91;
                     _loc20_ = 1;
                     switch(var_91)
                     {
                     ...
                     _loc21_ = var_69.getPartActionOffset(getSubType(),var_187,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_165 = new ActiveActionData(AvatarAction.const_881);
         var_165.definition = var_69.getActionDefinition(const_1044);
      ...
      {
         return var_69.getBodyPartData(param1.animation.id,var_445,param1.id);
      }
            ...
            case AvatarAction.const_558:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1202:
                     if(var_698 == AvatarType.const_87)
                     {
                        if(var_91 == 0)
                        {
