package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_578:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_689.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1277)
         {
            ...
            var_490["null"] = new FigureData(this);
            var_490["null"] = new FigureData(this);
            _loc1_ = var_490["null"];
            _loc2_ = var_490["null"];
            ...
            var_13 = new Map();
            var_13.add(AvatarEditorCategory.const_841,new GenericModel(this));
            var_13.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_13.add(AvatarEditorCategory.const_299,new TorsoModel(this));
            var_13.add(AvatarEditorCategory.const_1211,new LegsModel(this));
            var_13.add(AvatarEditorCategory.const_839,new WardrobeModel(this));
            var_1277 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_578 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1033 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1033 >= _loc14_.clubLevel))
               {
            ...
            if(_loc8_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1356.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1147)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_1033 >= _loc5_.clubLevel))
               {
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1356.clone() as IWindowContainer,param1,_loc5_,_loc12_,_loc15_);
                  _loc3_.push(_loc6_);
               }
            }
         }
         _loc3_.sort(orderByClub);
         _loc4_.sort(method_13);
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_13.getValue(AvatarEditorCategory.const_839);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_689.getPalette(param1);
      }
      ...
      private function method_13(param1:AvatarEditorGridColorItem, param2:AvatarEditorGridColorItem) : Number
      {
      ...
      {
         var_689 = var_527.getFigureData(AvatarType.const_87);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_527 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_223 == null)
            {
               var_223 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_841);
         if(var_578 != null)
         {
            var_578.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1033 = param3;
         var _loc4_:FigureData = var_490[param2];
         if(_loc4_ == null)
         {
            return;
         }
