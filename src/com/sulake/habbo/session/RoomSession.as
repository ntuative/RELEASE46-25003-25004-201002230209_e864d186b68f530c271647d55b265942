package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1011:UserDataManager;
      ...
      {
         if(var_34 == RoomSessionEvent.const_314 && _connection != null)
         {
            var_34 = RoomSessionEvent.const_92;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1011 as IUserDataManager;
      }
