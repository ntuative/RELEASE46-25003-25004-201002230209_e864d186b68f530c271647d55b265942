package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_977:HabboGroupInfoManager;
      
      private var var_1032:String;
      
      private var var_1826:Boolean;
      
      private var var_975:ProductDataParser;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_977 = new HabboGroupInfoManager(this,events);
         var_795 = new IgnoredUsersManager(this);
      ...
      {
         var_975.removeEventListener(ProductDataParser.READY,onProductsReady);
         var_975 = null;
         var_548 = new Map();
         var_451 = new Map();
         var_388 = new Map();
         ...
         var_976 = new FurnitureDataParser(_loc2_,var_548,var_451,var_388,_localization);
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_176.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_975 = new ProductDataParser(_loc2_,var_838);
         var_975.addEventListener(ProductDataParser.READY,onProductsReady);
      }
      ...
      {
         return var_977.getBadgeId(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         var_795.unignoreUser(param1);
      }
      ...
      {
         return var_1183.getBadgeImage(param1,BadgeImageManager.const_974);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _id = _loc3_.id;
         _name = _loc3_.name;
         var_2006 = _loc3_.respectTotal;
         var_796 = _loc3_.respectLeft;
         var_458 = _loc3_.petRespectLeft;
         var_540 = _loc3_.figure;
         var_1032 = _loc3_.sex;
         var_1231 = _loc3_.realName;
         var_795.initIgnoreList();
      }
      ...
      {
         return var_977.getGroupDetails(param1);
      }
      ...
      public function getFloorItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getFloorItemData(parseInt(var_388.getValue(param1)));
      }
      ...
      {
         return var_795.isIgnored(param1);
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_1827 = _loc2_.isOpen;
         var_1826 = _loc2_.onShutDown;
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return var_1183.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         var _loc2_:HabboGroupDetails = var_977.getGroupDetails(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_458 < 1 || _loc2_ == null)
         {
      ...
      public function getWallItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getWallItemData(parseInt(var_388.getValue(param1)));
      }
      
      public function ignoreUser(param1:String) : void
      {
         var_795.ignoreUser(param1);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_977.communication = _communication;
         var_795.registerMessageEvents();
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_548.getValue(param1.toString());
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1183 = new BadgeImageManager(_loc1_,events,var_176,_localization);
      }
