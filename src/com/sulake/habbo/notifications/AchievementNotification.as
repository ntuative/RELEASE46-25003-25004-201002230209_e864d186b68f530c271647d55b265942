package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_2031 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_319 != null)
         {
            var_319.events.removeEventListener(BadgeImageReadyEvent.const_113,onBadgeImageReady);
            var_319 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_680,var_2031);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_680,var_680));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_680,var_680));
         _localizations.registerParameter(param1,"level",var_1643.toString());
         _localizations.registerParameter(param1,"name",var_319.userName);
         _localizations.registerParameter(param1,"realname",var_319.realName);
      }
   }
}
