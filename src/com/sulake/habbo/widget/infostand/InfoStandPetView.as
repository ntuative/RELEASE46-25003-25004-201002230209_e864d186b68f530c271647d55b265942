package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1617:String = "level";
      ...
      private const const_1625:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1620:uint = 3355443;
      
      private var var_230:IBorderWindow;
      
      private const const_1618:int = 158;
      
      private const const_1624:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_259:PetCommandTool;
      
      private const const_1622:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_230 != null)
         {
            var_105 = var_230.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_105 == null || var_230 == null || var_60 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_259 == null)
         {
            var_259 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1163.getValue(var_630) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_259.showWindow(true);
            var_259.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1617,param1.level,param1.levelMax);
         ...
         updateStateElement(const_1625,param1.nutrition,param1.nutritionMax);
         ...
         if(var_259 && var_259.isVisible() && param1.isOwnPet)
         {
            var_259.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_259.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_381,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1618,const_1624,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1622);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1620);
