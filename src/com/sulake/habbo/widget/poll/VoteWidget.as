package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_628:Array = null;
      ...
      private var var_1030:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_128,method_10);
      ...
      private function method_10(param1:RoomWidgetVoteUpdateEvent) : void
      {
         var _loc6_:* = null;
         var _loc12_:* = null;
         if(param1 == null)
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1687;
         if(_loc2_ > var_1266)
         {
            vote();
            return;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_128,method_10);
