package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_421:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_421 = new Sprite();
            var_421.addChild(new Bitmap(_image));
            var_421.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_421.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_421);
         _window.visible = true;
         _window.center();
      }
      ...
      override public function dispose() : void
      {
         if(var_421 != null)
         {
            var_421.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_421 = null;
         }
         if(_image != null)
         {
