package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_146.state = RoomChatHistoryPulldown.const_218;
         ...
         var_42 = param2.createWindow("chatscroller","",HabboWindowType.const_930,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_289 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_212 > 0 && param2)
         {
            if(var_1154)
            {
               if(Math.abs(param1 - var_212) <= const_884)
               {
                  return;
               }
               var_1154 = false;
            ...
            if(var_289)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_42.scrollV < 1 - const_1051 / var_42.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1401)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_289 && !var_1115)
         {
            ...
            var_146.state = RoomChatHistoryPulldown.const_333;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_146.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_218);
      }
