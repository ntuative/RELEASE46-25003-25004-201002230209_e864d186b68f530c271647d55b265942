package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1103:int = 9;
      
      private static const const_775:int = 4000;
      
      private static const const_1105:int = 3;
      
      private static const const_94:int = 18;
      
      private static const const_1040:int = 25;
      ...
      private static const const_491:int = (const_490 + const_344) * const_94 + const_94;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_224 = new Array();
         var_691 = new Point();
         var_154 = const_491 + const_275;
         super(param1,param2,param3);
         var_2078 = param5;
         var_38 = param1.createWindow("chat_container","",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_39,new Rectangle(0,0,200,var_154 + RoomChatHistoryPulldown.const_72),null,0) as IWindowContainer;
         var_38.background = true;
         var_38.color = 33554431;
         var_38.tags.push("room_widget_chat");
         var_345 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1003,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,200,var_154),null,0) as IItemListWindow;
         var_38.addChild(var_345);
         var_138 = param1.createWindow("chat_active_content","",HabboWindowType.const_56,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,200,var_154),null,0) as IWindowContainer;
         var_345.addListItem(var_138);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_154 = const_491 + const_275;
         var_38.height = var_154 + var_24.pulldownBarHeight;
         var_345.width = 0 - 0;
         var_345.height = var_154;
         var_138.width = 0 - 0;
         if(historyViewerActive())
         {
            var_138.height = getTotalContentHeight() + const_275;
         }
         else
         {
            var_138.height = var_154;
         }
         var_345.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_884)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_65.length > const_1106 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_693 = getTimer() + const_775;
         }
         else
         {
            if(false && false)
            {
               var_579 = getItemSpacing(_itemList["-1"],var_65[0]);
            }
            else
            {
               var_579 = const_94;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_691.x) * var_862;
      ...
      {
         return "chat_" + var_2078.toString() + "_item_" + (var_2077++).toString();
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1040 * const_1105;
            if(_loc2_ + var_692 > var_579)
            {
               _loc2_ = var_579 - var_692;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1513 == 0)
            {
               var_1513 = param1.scale;
            }
            else
            {
               var_862 = param1.scale / var_1513;
            }
         }
         if(param1.positionDelta != null)
         {
            var_691.x += param1.positionDelta.x / var_862;
            var_691.y += param1.positionDelta.y / var_862;
         }
         if(param1.rect != null)
         {
            if(var_24 == null)
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_490 + const_344 + 2)
               {
                  _loc1_.aboveLevels = const_490 + const_344 + 2;
               }
               var_491 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_154 = param1 - 0;
         var_38.height = var_154 + RoomChatHistoryPulldown.const_72;
         if(var_24 != null)
         {
            var_24.containerResized(var_38.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_644,param1,param3,param4);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_344 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1104)
               {
