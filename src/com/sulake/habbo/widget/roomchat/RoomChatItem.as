package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_343:int = 10;
      
      private static const const_1099:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_1020,var_1022,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1020,var_1022,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1255 = param1.chatType;
         var_1020 = param1.userId;
         var_845 = param1.userName;
         var_1022 = param1.userCategory;
         _message = param1.text;
         var_1256 = param1.userX;
         var_200 = param1.userImage;
         var_1021 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1255)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_99:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_264:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_227:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1021 != 0)
            {
               _loc30_ = uint(var_1021 >> 16 & 255);
               _loc31_ = uint(var_1021 >> 8 & 255);
               _loc32_ = uint(var_1021 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_343;
            }
            else
            {
               _loc19_.text = var_845 + ":";
               _loc19_.y += var_402;
               _loc19_.width = _loc19_.textWidth + const_343;
               _width += _loc19_.textWidth + const_343;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1255 == RoomWidgetChatUpdateEvent.const_264)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_845);
            }
            else if(var_1255 == RoomWidgetChatUpdateEvent.const_227)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_845);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_343 + _loc20_.textWidth + const_488;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1020,var_1022,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1020,var_1022,_roomId,_roomCategory,param1);
      }
