package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_89 && param1.type != WindowMouseEvent.const_416)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1492 * (var_1023 - var_677)) + var_677;
      }
   }
}
