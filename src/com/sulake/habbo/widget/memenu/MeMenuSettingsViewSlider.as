package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_898:MeMenuSettingsView;
      
      private var var_2366:int;
      
      private var var_566:BitmapData;
      
      private var var_1023:Number = 1;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_898.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_566 != null)
            {
               ...
               var_1492 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1492 * (Number(param1 - var_677) / (var_1023 - var_677)));
      }
      ...
      {
         return param1 / var_1492 * (var_1023 - var_677) + var_677;
      }
   }
}
