   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_783 = _window.findChildByName("effect_hilite");
            var_783.visible = false;
         }
         var_782 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_781 = _window.findChildByName("loader_bar");
         if(var_781 != null)
         {
            var_416 = var_781.width;
            var_169.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_782 != null)
         {
            var_782.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_782.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
