package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_149[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_149[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_149)
         {
            _loc6_ = var_149[_loc3_];
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         var_149["rooms_icon"] = ["gohome_white","gohome_color"];
         var_149["dance_icon"] = ["dance_white","dance_color"];
         var_149["clothes_icon"] = ["clothes_white","clothes_color"];
         var_149["effects_icon"] = ["effects_white","effects_color"];
         var_149["badges_icon"] = ["badges_white","badges_color"];
         var_149["wave_icon"] = ["wave_white","wave_color"];
         var_149["hc_icon"] = ["_white","_color"];
         var_149["settings_icon"] = ["settings_white","settings_color"];
         var_149["credits_icon"] = ["credits_white","credits_color"];
         var_149["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_862);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1013));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1016));
               _widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_587));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_720);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","NoSuchFlatMessageParser") == "true";
               if(false && _loc4_)
               {
