package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_416:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1002 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1942 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1940 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_662 = new Timer(1000,1);
         var_662.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_821 = new Timer(5000,1);
         var_821.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1941 = _loc2_.width + const_488 + _loc6_.width + const_1081;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1082,_loc8_.width) + const_488);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1002 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_130 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_416);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_416);
         }
