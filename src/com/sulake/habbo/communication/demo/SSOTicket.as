package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      public static const const_282:String = "success";
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         var_1258.init();
         var_1258.addEventListener(HabboWeb.const_215,requestClientURL);
      }
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         else
         {
            try
            {
               var_1491 = /\"sso.ticket\" : \"(.*?)\"/.exec(data)[1];
               var_2026 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               if(false)
               {
                  dispatchEvent(new Event(const_282));
               }
               else
               {
