package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_626:String = "InitConnection";
      ...
      private var var_326:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_109:SSOTicket;
      ...
      {
         var_326.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_326.shockwaveClientUrl = var_109.shockwaveClientUrl;
         var_326.ssoTicket = var_109.ticket;
         var_109.removeEventListener(SSOTicket.const_282,onParsedTicketSuccess);
         var_109.removeEventListener(SSOTicket.const_266,onParsedTicketFailure);
         var_109 = null;
         dispatchEvent(new Event(const_626));
      }
      ...
      {
         var _loc1_:XmlAsset = (var_326 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_326.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_445,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_326.windowManager.buildFromXML(_loc2_) as IWindowContainer;
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_326.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_326.habboCommunication.habboWebLogin(name,password);
         var_109 = new SSOTicket(var_326.assets,_loc2_,_loc1_);
         var_109.addEventListener(SSOTicket.const_282,onParsedTicketSuccess);
         var_109.addEventListener(SSOTicket.const_266,onParsedTicketFailure);
      }
