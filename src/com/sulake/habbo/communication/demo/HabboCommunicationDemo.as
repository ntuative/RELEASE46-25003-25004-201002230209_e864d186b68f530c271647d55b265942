package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2114:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_97:IHabboConfigurationManager;
      
      private var var_1526:ILogger;
      ...
      private var var_494:IKeyExchange;
      ...
      private var var_74:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_319:
               _loc3_ = var_97.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_836:
               _loc3_ = var_97.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_872:
               _loc3_ = var_97.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_928:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2115)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1292,var_2113));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_494.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_494.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2114);
      ...
      {
         var_700 = var_97.getKey("sso.ticket",null);
         var_1292 = var_97.getKey("flash.client.url","");
         var_2113 = var_97.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_700 != null)
         {
            var_74.mode = HabboConnectionType.const_360;
            var_74.initConnection(HabboConnectionType.const_229);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1526 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_74 = param2 as IHabboCommunicationManager;
            _loc3_ = var_74.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_74.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_74.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_74.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_74.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_74.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_74.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_74.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_74.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_74.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_74.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_74.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_74.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_74.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_658);
            _loc3_ = new InitCryptoMessageComposer(var_74.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2114 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_74.mode)
         {
            case HabboConnectionType.const_360:
               _loc6_ = "";
               ...
               var_1038 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1038,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1359:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1135:
               var_1037 = generateRandomHexString(30);
               var_494 = new DiffieHellman(new BigInteger(var_97.getKey("connection.development.prime"),16),new BigInteger(var_97.getKey("connection.development.generator"),16));
               var_494.init(var_1037);
               _loc8_ = var_494.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc9_:IConnection = var_74.getHabboMainConnection(null);
         ...
         var_494 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_1037 = generateRandomHexString(30);
            var_494.init(var_1037);
            _loc12_ = var_494.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(var_97).events.addEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_101,onRoomSessionEnded);
      }
