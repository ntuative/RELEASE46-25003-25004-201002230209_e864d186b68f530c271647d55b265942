package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2350:Dictionary;
      ...
      private var var_761:RoomCreateViewCtrl;
      ...
      private var var_532:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_370:Tabs;
      
      private var var_250:MainViewCtrl;
      
      private var var_1642:Array;
      
      private var var_982:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_250 = new MainViewCtrl(this);
         var_532 = new RoomInfoViewCtrl(this);
         var_761 = new RoomCreateViewCtrl(this);
         var_1641 = new RoomThumbnailRenderer(this);
         var_982 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_250.startSearch(Tabs.const_207,Tabs.const_300,param1);
         var_250.mainWindow.activate();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_760)
         {
            var_760.release(new IIDSessionDataManager());
            var_760 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_184 != null)
         {
            var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_760 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_250.startSearch(Tabs.const_228,Tabs.const_219);
         var_370.getTab(Tabs.const_228).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_250.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
