package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboNavigator)
      {
         ...
         _loc2_.addHabboConnectionMessageEvent(new RoomInfoUpdatedEvent(method_14));
      ...
      private function onFavouriteChanged(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Received favourite changed: " + _loc2_.flatId + ", " + _loc2_.method_12);
         _navigator.data.favouriteChanged(_loc2_.flatId,_loc2_.method_12);
