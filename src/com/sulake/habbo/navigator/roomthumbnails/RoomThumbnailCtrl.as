package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1515,this._model.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1516,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1515 = IButtonWindow(find("top_tab"));
         var_1516 = IButtonWindow(find("obj_tab"));
         var_2081 = IWindowContainer(find("tile_grid"));
         var_2080 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1515,onTopTabButton);
         Util.setProcDirectly(var_1516,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2081;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_420)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2080;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
