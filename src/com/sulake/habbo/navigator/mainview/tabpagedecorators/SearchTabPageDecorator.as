package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1378:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_194,"-1",MainViewCtrl.const_573);
      }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         else if(_navigator.data.guestRoomSearchArrived)
         {
            ...
            if(_navigator.data.guestRoomSearchResults.searchType == Tabs.const_300)
            {
               ...
               _navigator.registerParameter("navigator.tagsearchresults","tag_name",padCommas(_navigator.data.guestRoomSearchResults.method_6));
               _loc4_.visible = true;
            }
            else
            {
               _navigator.registerParameter("navigator.textsearchresults","room_count","" + _navigator.data.guestRoomSearchResults.rooms.length);
               _navigator.registerParameter("navigator.textsearchresults","search_str","" + _navigator.data.guestRoomSearchResults.method_6);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1378 == null)
         {
            ...
            var_1378 = new TextSearchInputs(_navigator,false,_loc4_);
            initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(_navigator.data.guestRoomSearchArrived && _navigator.data.guestRoomSearchResults.searchType == Tabs.const_194)
         {
            var_1378.searchStr.setText(_navigator.data.guestRoomSearchResults.method_6);
         }
