package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_271,Tabs.const_292);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_271,Tabs.const_526);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_271,Tabs.const_292,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_507 == null)
         {
            var_507 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_507.procedure = onChangeFilter;
