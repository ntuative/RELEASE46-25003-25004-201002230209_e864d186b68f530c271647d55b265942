package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_496 = new Timer(100);
         var_496.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_64 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1045 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1660 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_496)
         {
            var_496.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_496.reset();
            var_496 = null;
         }
      }
      ...
      private function refresh() : void
      {
         ...
         var_882 = var_64[0];
         if(var_1660 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1315 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1315 = true;
            _loc3_.y = 1;
