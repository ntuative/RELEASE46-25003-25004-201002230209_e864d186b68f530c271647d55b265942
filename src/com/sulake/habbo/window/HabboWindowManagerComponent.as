package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1202:ProfilerAgentTask;
      
      private var var_1203:IEventDispatcher;
      
      private var var_2356:uint = 0;
      
      private var var_1200:ProfilerAgentTask;
      
      private var var_1201:ProfilerOutput;
      
      private var var_651:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1203 = Component(param1).events;
         var_392 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_651 = new WindowRenderer(_loc4_);
         var_214 = new Array(const_341);
         var _loc6_:int = 0;
         while(_loc6_ < const_341)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_651,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_214[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_223 = var_214[const_1060];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_223.getMouseCursor().defineCustomCursorType(MouseCursorType.const_281,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_223.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1241,_loc7_);
      }
      ...
      {
         return var_214[param1].getDesktopWindow().getChildAt(var_223.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1201 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1201 = new ProfilerOutput(_loc3_,this,var_651);
               var_1202 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1202);
               var_1200 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1200);
               var_987 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1203.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_341 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1203.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         var_1203.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_392[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_392[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1189,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1160,param2.name + ": " + param2.toString());
            }
         }
      }
   }
