package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_405.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_405.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_405.removeStopEventListener(refresh);
            var_405 = null;
            _windowManager = null;
            var_651 = null;
            _disposed = true;
