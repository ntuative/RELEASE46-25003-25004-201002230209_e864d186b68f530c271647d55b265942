package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_832:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_473,0,0,_loc4_,var_1475,var_833,var_832));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1978 = int(_config.getKey("interstitial.interval","30000"));
         var_1979 = int(_config.getKey("interstitial.show.time","5000"));
         var_1476 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1475 = _loc2_.clickUrl;
         if(var_1235 != "" && var_1475 != "")
         {
            _loc3_ = var_1235;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1236 != "")
         {
            ...
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_30,method_9);
            _loc5_.addEventListener(AssetLoaderEvent.const_43,method_9);
         }
         else
         {
            stopInterstitial();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_463,0,0,param1.bitmapData,var_1977));
            var_666 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_832 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1476 > 0 && var_1477 >= var_1476)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_666;
         if(_loc1_ > var_1978)
         {
            ++var_1477;
      ...
      {
         var_294 = param2 as IHabboCommunicationManager;
         if(var_294 == null)
         {
            return;
         }
         _connection = var_294.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_833 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
