package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_340:String = "place_holder";
      
      private static const const_1050:String = const_340;
      ...
      public function RoomContentLoader()
      {
         var_450 = [];
         var_451 = [];
         var_1758 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1754 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_380 = new Map();
         _events = new Map();
      ...
      {
         if(var_166 != null && var_166.hasWorldType(const_274 + param1))
         {
            return var_166.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_452.add(_loc10_,_loc11_);
                              if(var_450.indexOf(_loc14_) < 0)
                              {
                                 var_450.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_380 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_380.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_380.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_543.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_380.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_340,const_483,ROOM_CONTENT,const_744,const_745];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1758.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_165 && _loc5_ != RoomObjectLogicEnum.const_106)
         {
            _loc6_ = "@shadow";
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_378 != null)
         {
            _loc2_ = var_378.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1292);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1754.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_248;
         }
         return RoomObjectCategoryEnum.const_186;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1756)
         {
            ...
            if(var_962 != null)
            {
               var_962.dispatchEvent(new Event(const_676));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_166 != null)
         {
            return var_166.getWorldHeightScale(const_274 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_962 = param1;
            var_1755 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1757 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1753 = param2.getKey("public.room.dynamic.download.url","");
            var_1752 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_34 = const_743;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_378 != null)
         {
            ...
            var_378.add(param1,param2);
         }
         if(var_379 != null)
         {
            var_379.remove(param2);
            var_379.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_165 && _loc5_ != RoomObjectVisualizationEnum.const_106)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_274 + param1) == RoomObjectCategoryEnum.const_62)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_166 = var_1152.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_166 != null)
         {
            return var_166.getWorldScale(const_274 + param1);
         }
         return 32;
      }
