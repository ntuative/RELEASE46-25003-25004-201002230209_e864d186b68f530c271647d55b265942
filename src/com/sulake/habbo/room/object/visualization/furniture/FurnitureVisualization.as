package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2258:Number = NaN;
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2268,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2057 != param1 || var_2059 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_2060 != param1 || var_2058 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2268 = _loc3_.getNumber(RoomObjectVariableEnum.const_223);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_204));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1561 = _loc3_.getString(RoomObjectVariableEnum.const_334);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_283 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2258)
         {
