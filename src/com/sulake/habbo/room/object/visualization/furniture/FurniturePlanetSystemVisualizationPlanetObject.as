package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         var _loc3_:Number = var_1337 * Math.cos(var_820 + var_1467);
         var _loc4_:Number = var_1337 * Math.sin(var_820 + var_1467);
         var _loc5_:Number = _height;
         var_661.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_661.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_661.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_661.add(param1);
         }
