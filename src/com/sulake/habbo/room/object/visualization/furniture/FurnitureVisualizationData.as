package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_283:int = 1000;
      ...
      private var var_437:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_437 = var_241.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_437 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_241 != null)
         {
            ...
            {
               _loc1_ = var_241.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_241.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_241.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
