package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1177:int = const_284;
      ...
      public static const const_191:int = 4;
      
      public static const const_689:int = 6;
      
      public static const const_238:int = const_95;
      ...
      private var var_1105:Boolean = true;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1601 = param6;
         var_1600 = param7;
         var_749 = new Vector3d();
         if(var_1376 == const_689)
         {
            var_1105 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1375 == const_95)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_436);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_436,var_26.width,var_436);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_749,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_436,param6,param7);
                     return param1;
                  }
                  return var_26;
               }
