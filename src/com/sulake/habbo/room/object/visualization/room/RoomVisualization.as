package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1069:int = 16777215;
      
      public static const const_1328:int = 10066329;
      
      private static const const_1071:int = 13421772;
      
      public static const const_1268:int = 16777215;
      
      private static const const_1403:int = 0;
      
      public static const const_1279:int = 16777215;
      ...
      private var var_1905:int = -1000;
      
      private var var_989:uint = 16777215;
      ...
      private const const_1610:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         while(_loc7_ < var_77.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_182,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
         ...
         while(_loc5_ < var_394.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_100.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_256 || _loc3_.type == RoomPlane.const_184 && _loc8_ == RoomPlaneBitmapMaskData.const_197)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1422;
                        if(var_77.getPlaneType(_loc9_) == RoomPlaneData.const_146)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1338)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1069 || _loc9_.y != var_1900 || _loc9_.z != var_1899 || param1.scale != var_1903))
            {
               var_1069 = _loc9_.x;
               var_1900 = _loc9_.y;
               var_1899 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_793);
            if(_loc10_ != var_1898)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_733));
            if(_loc11_ != var_989)
            {
               var_989 = _loc11_;
               var_1902 = var_989 & 255;
               var_1906 = var_989 >> 8 & 255;
               var_1901 = var_989 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1905 + const_1610 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1905 = _loc7_;
         if(var_160 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_544);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_582);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_657);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1904 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_895));
         ...
         while(_loc8_ < var_393.length)
         {
            ...
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_184)
            {
               if(var_1904)
               {
                  ...
                  _loc19_ = uint((_loc18_ & 255) * var_1902 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1906 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1901 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_100.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_182 && param1 != null)
               {
                  _loc5_.id = param1;
               }
