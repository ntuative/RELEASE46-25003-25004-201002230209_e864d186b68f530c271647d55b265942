package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1419:int = 0;
      
      private var var_540:String;
      
      private var var_617:int = 0;
      
      private const const_1615:int = 1;
      ...
      private var var_829:AvatarVisualizationData = null;
      ...
      {
         var_829 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_397.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_574);
         ...
         var _loc14_:Number = _loc8_ - var_1294;
         ...
         var _loc21_:Boolean = _isAnimating || var_495 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_495;
            ...
            if(var_540 != _loc7_)
            {
               for each(_loc49_ in var_397.getKeys())
               {
                  var_397.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_829.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_397.remove(_loc5_);
               var_397.add(_loc5_,_loc6_);
               var_540 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_324);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_268) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_268);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_736);
            _loc6_.appendAction(AvatarAction.const_558,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_475);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_50)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_439);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_293,AvatarAction.const_1152[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_822);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_828,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_924);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1011);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_916,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_571);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_578);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_898,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_806);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_831,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_440);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_356) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_713);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_413);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_996);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_535,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1616);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_825))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_829.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_830.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_830)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_397 != null)
         {
            _loc1_ = var_397.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_397.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
