package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1510:int = 1500;
      
      private var var_1511:int = 255;
      
      private var var_1509:int = 255;
      
      private var var_1281:uint = 16777215;
      
      private var var_1034:uint = 16777215;
      
      protected var var_77:RoomPlaneParser = null;
      
      private var var_858:int = 0;
      
      private var var_1147:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_608:
                  ...
                  break;
               case RoomObjectRoomUpdateMessage.const_737:
                  _loc2_.setString(RoomObjectVariableEnum.const_544,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_691:
                  _loc2_.setString(RoomObjectVariableEnum.const_657,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_384:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_197)
                  {
                     _loc8_ = "null";
                  }
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_793,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_895,int(_loc5_.bgOnly));
            var_1281 = _color;
            var_1511 = var_1147;
            var_1034 = _loc11_;
            var_1509 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_733,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1140,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1354,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1237,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_134 || _loc13_ == RoomPlaneData.const_230)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_858)
         {
            ...
            {
               _loc7_ = var_1281 >> 16 & 255;
               _loc8_ = var_1281 >> 8 & 255;
               _loc9_ = var_1281 & 255;
               _loc10_ = var_1034 >> 16 & 255;
               _loc11_ = var_1034 >> 8 & 255;
               _loc12_ = var_1034 & 255;
               _loc13_ = (_loc2_ - var_858) / var_1510;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1511 + (var_1509 - var_1511) * _loc13_;
               _color = _loc3_;
               var_1147 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_733,_loc3_);
         }
      }
   }
}
