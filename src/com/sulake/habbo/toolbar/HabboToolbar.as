package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_294.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_480,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_672,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_837,onHideWindowEvent);
         var_34 = true;
