package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1105:Number = 90;
      
      private static const const_740:int = 50;
      
      private static const const_1040:Number = 25;
      ...
      private var var_945:ToolbarView;
      ...
      private function method_3(param1:String, param2:IWindowContainer, param3:Number) : Point
      {
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_442.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_442.splice(_loc3_,1);
            var_443.splice(_loc3_,1);
         }
         var_443.push(param1.name);
         var_442.push(param2);
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_945.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_286.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_286.splice(var_286.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_945.getIconLoc(param1.iconId);
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_286[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_534[_loc3_] = new Array();
            }
            if(var_534[_loc3_].indexOf(param1) < 0)
            {
               var_534[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_740 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_740 || param1.desktop.height - param1.y < const_1041;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_443[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_534[_loc3_].length)
                  {
                     repositionWindow(var_534[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      public function animateWindowIn(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         ...
         _loc8_.offsetLoc = method_3(param2,param3,param5);
         if(const_175)
         {
      ...
      public function positionWindow(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:Array = null) : void
      {
         ...
         _loc7_.offsetLoc = method_3(param2,param3,param5);
         if(const_175)
         {
