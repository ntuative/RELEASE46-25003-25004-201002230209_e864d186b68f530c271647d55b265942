package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_843:IRoomSession;
      ...
      private const const_1626:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_45.getValue(InventoryCategory.const_566));
      }
      ...
      {
         return PetsModel(var_45.getValue(InventoryCategory.const_157));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1626);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_844.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_844.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_45.getValue(InventorySubCategory.const_267));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_319 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_844.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_45.getValue(InventoryCategory.const_432) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1018 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_45.getValue(InventoryCategory.const_273));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
         ...
         var_45.add(InventoryCategory.const_432,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_319);
         var_45.add(InventoryCategory.const_273,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_45.add(InventoryCategory.const_566,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_319);
         ...
         var_45.add(InventorySubCategory.const_267,_loc8_);
         ...
         var_45.add(InventoryCategory.const_157,_loc10_);
