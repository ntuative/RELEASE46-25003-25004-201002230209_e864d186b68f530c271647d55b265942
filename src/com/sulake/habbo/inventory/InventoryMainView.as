package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1319);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_713 == InventoryCategory.const_157)
            {
               toggleCategoryView(InventoryCategory.const_157);
            }
            else if(var_713 == InventoryCategory.const_69)
            {
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_184 != null)
         {
            var_184.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_184 != null)
         {
            var_184.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_672,HabboToolbarIconEnum.INVENTORY,var_12 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         var_11.inventoryViewOpened(var_712);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_713 || !var_11.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_184 != null && var_886)
