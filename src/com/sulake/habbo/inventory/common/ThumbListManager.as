package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_559 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_559.width;
         var_93 = var_559.height;
         var_1004 = param5;
         var_828 = param6;
         var_217 = Math.floor(var_1004 / _thumbWidth);
         var_19 = new BitmapData(var_1004,var_828);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_19.height < var_828)
         {
            _loc12_ = new BitmapData(var_19.width,var_828);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_559.width,var_559.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_559.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_559,var_559.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_473 = resolveRowCountFromList();
         if(var_473 == 0)
         {
            var_19 = new BitmapData(var_1004,var_828);
            return;
         }
         var_19 = new BitmapData(Math.max(var_217 * _thumbWidth,var_1004),Math.max(var_473 * var_93,var_828),true,16777215);
         var_19.fillRect(var_19.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_473)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_217 && var_19.height < _loc3_.y * var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_217 - 1),var_93);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_217 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_93),null,null,true);
         _loc4_ = new Rectangle(0,var_93,_thumbWidth * (var_217 - 1),0 - var_93);
