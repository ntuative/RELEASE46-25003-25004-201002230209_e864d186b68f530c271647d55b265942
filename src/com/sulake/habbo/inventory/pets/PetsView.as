package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      {
         if(var_592 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_592.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_592.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_592.getValue(param1.id) != null)
         {
            return;
         }
