package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1327 && param1.type == RoomEngineObjectEvent.const_193)
         {
            var_11.showView();
            var_1327 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1327 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_34,RoomObjectTypeEnum.const_278,_loc3_.figure);
            var_11.closeView();
            return;
         }
      ...
      {
         if(var_963.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
