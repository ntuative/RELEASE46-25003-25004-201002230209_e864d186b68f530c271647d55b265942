package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1505 = getTimer();
         var_489.add(var_1272,var_1505);
         _connection.send(new LatencyPingRequestMessageComposer(var_1272));
         ++var_1272;
      }
      ...
      public function init() : void
      {
         ...
         var_1507 = int(var_176.getKey("latencytest.interval"));
         var_1506 = int(var_176.getKey("latencytest.report.index"));
         var_2067 = int(var_176.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_153.push(_loc4_);
         if(var_153.length == var_1506 && var_1506 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1508) > var_2067 || var_1508 == 0)
            {
               var_1508 = _loc9_;
