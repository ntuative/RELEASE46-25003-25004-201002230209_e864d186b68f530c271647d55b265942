package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_228:PerformanceTracker = null;
      
      private var _adManager:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_407:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1036:int = -1;
      
      private var var_1291:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_228 = new PerformanceTracker();
         var_227 = new LatencyTracker();
         var_1291 = new LagWarningLogger();
         var_1290 = new Array(const_778);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1371,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1318,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1272,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_588,String(false));
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_658:
               trackLoginStep(HabboLoginTrackingStep.const_1183,String(_communication.port));
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_280:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_176)
         {
            Component(var_176).events.addEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
            if(var_227 != null)
            {
               var_227.configuration = var_176;
            }
            if(var_228 != null)
            {
               var_228.configuration = var_176;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_473,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2108)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1250);
            var_2108 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_588,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_658,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_435,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_391:
               var_1291.registerWarning(LagWarningLogger.const_821);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_175)
            {
               if(true)
               {
                  Component(var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_175).events.removeEventListener(HabboFriendListTrackingEvent.const_280,onFriendlistTrackingEvent);
               }
               var_175.release(new IIDHabboFriendList());
               var_175 = null;
            }
            if(var_407)
            {
               if(true)
               {
                  var_407.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_407.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_407.release(new IIDHabboHelp());
               var_407 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_391,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_176)
         {
            Component(var_176).events.removeEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_85);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_85,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_407 = param2 as IHabboHelp;
         var_407.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_407.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_940);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_940,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1036 > -1 && _loc2_ < var_1036)
         {
            ++var_1524;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1524);
         }
         if(var_1036 > -1 && _loc2_ - var_1036 > 15000)
         {
            ++var_1523;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1523);
         }
         var_1036 = _loc2_;
         if(var_228 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_391,onLagWarningEvent);
      ...
      {
         var_175 = param2 as IHabboFriendList;
         Component(var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_175).events.addEventListener(HabboFriendListTrackingEvent.const_280,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_176)
            {
               if(var_176.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_228 != null)
                  {
                     _loc4_["null"] = var_228.flashVersion;
                     _loc4_["null"] = var_228.averageUpdateInterval;
                  }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_85,onLocalizationLoaded);
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1287);
         }
         else if(param1.type == HabboHotelViewEvent.const_435)
         {
