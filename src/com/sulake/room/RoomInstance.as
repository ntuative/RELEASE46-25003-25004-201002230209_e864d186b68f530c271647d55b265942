package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_229.getValue(_loc2_) != null)
         {
            _loc3_ = var_229.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_229 != null)
         {
            ...
            {
               _loc3_ = var_229.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc2_:int = var_465.indexOf(param1);
         if(_loc2_ >= 0)
         {
            var_465.splice(_loc2_,1);
         }
      }
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(var_470[param1] != param2)
         {
            var_470[param1] = param2;
         }
      }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_229.getValue(_loc2_) != null)
         {
            return var_229.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_229.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_229.getValue(String(param1)) as IRoomObjectManager;
      }
