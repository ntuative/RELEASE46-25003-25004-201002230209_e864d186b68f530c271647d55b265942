package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_785:int = 50;
      ...
      private var var_2176:Number = -10000000;
      
      private var var_2173:Number = -10000000;
      
      private var var_2342:int = 0;
      
      private var var_501:RoomObjectCache;
      
      private var var_718:int;
      
      private var var_272:Sprite;
      
      private var var_1054:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1053 == 0)
         {
            checkMouseHits(var_1055.x,var_1055.y,MouseEvent.MOUSE_MOVE);
         }
         var_1053 = 0;
         ++var_1551;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_272 != null)
         {
            var_272.graphics.clear();
         }
         else
         {
            var_272 = new Sprite();
            var_272.name = "mask";
            _master.addChild(var_272);
         }
         var_272.graphics.beginFill(0);
         var_272.graphics.drawRect(0,0,param1,param2);
         var_718 = param1;
         var_720 = param2;
         var_53.graphics.clear();
         var_53.graphics.beginFill(var_2342);
      ...
      {
         var _loc11_:Number = param1 - var_718 / 2;
         var _loc12_:Number = param2 - var_720 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_718 != var_2174 || var_720 != var_2175)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         if(_loc6_ < var_418.length)
         {
            var_418.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_418[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_719.push(_loc12_ - _loc2_);
         if(var_719.length == const_785)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_785)
            {
               _loc13_ += var_719[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_502 != null)
         {
            ...
            {
               cleanSprite(var_502[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_502 = [];
         }
         ...
         while(_loc1_ < var_309.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1054 != null)
                  {
                     var_1054.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1551,geometry);
                  }
                  else
                  {
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_500.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                        if(_loc13_.method_1 != _loc16_)
                        {
                           _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.method_1,param4,param5,param6,param7);
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_500.add(_loc9_,_loc13_);
                     }
                     _loc13_.method_1 = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2176 || param2 != var_2173)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_500.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_500.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.method_1,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_502.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_501.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_501.getObjectCache(param2);
         ...
         _loc12_ += int(var_718 / 2);
         _loc13_ += int(var_720 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_718 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_720))
                  {
