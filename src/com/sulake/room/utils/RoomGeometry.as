package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_816:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1416 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_387 != param1 * var_1414)
         {
            var_387 = param1 * var_1414;
            ++var_76;
         }
      }
      ...
      {
         if(var_386 != param1 * var_1415)
         {
            var_386 = param1 * var_1415;
            ++var_76;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_385 != null)
         {
            ...
            var_385.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_385.add(_loc3_,_loc4_);
            ++var_76;
         }
      }
      ...
      {
         return new Vector3d(0 * var_387,0 * var_386,0 * var_384);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_385 != null)
         {
            ...
            return var_385.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_387,0 * var_386,0 * var_384);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_88;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_387,param2.y * var_386,param2.z * var_384);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_387,param3.y * var_386,param3.z * var_384);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_387,param4.y * var_386,param4.z * var_384);
