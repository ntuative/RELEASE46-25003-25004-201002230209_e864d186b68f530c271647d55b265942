package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private static var var_1207:int = 0;
      ...
      public function RoomObject(param1:int, param2:int)
      {
         ...
         var_1500 = new Vector3d();
         var_479 = new Array(param2);
      ...
      {
         var_1500.assign(var_213);
         return var_1500;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_479.length)
         {
            if(var_479[param2] != param1)
            {
               var_479[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      {
         if(param1 >= 0 && param1 < var_479.length)
         {
