package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_848:uint = 4;
      ...
      protected var var_2061:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_928 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_928);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1103 & const_848)
         {
            if(_loc3_ == 0)
            {
