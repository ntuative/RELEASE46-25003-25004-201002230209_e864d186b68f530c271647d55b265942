package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1079:String = "_SCALER";
      
      private static const const_1059:String = "_TITLE";
      
      private static const const_1078:String = "_CONTENT";
      
      private static const const_762:String = "margin_left";
      
      private static const const_763:String = "margin_bottom";
      ...
      private var var_1216:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_761,_loc3_.top,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_760,0 - _loc3_.right,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_763,0 - _loc3_.bottom,PropertyStruct.const_63,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_270);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1216 == null)
         {
            var_1216 = findChildByTag(const_1077) as IHeaderWindow;
            if(!var_1216)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1059) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1079) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1363 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1078) as IWindowContainer;
            if(!var_20)
            {
