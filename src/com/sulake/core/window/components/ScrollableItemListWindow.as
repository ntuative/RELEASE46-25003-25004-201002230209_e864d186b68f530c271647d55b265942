   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_358)
         {
            ...
            if(var_358)
            {
               var_358.addEventListener(WindowEvent.const_246,scrollBarEventProc);
               var_358.addEventListener(WindowEvent.const_210,scrollBarEventProc);
            }
         }
         return var_358;
      }
      ...
      override public function dispose() : void
      {
         if(var_358)
         {
            var_358.removeEventListener(WindowEvent.const_246,scrollBarEventProc);
            var_358.removeEventListener(WindowEvent.const_210,scrollBarEventProc);
            var_358 = null;
         }
         if(var_915)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_915)
         {
            var_915 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_915;
      }
