package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1091:String = "content";
      ...
      protected var var_927:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1589 == null)
         {
            var_1589 = findChildByTag(TabContextController.const_1091) as IWindowContainer;
         }
         return var_1589;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_927 == null)
         {
            var_927 = findChildByTag(TabContextController.const_1092) as ITabSelectorWindow;
            if(var_927 != null)
            {
               var_927.procedure = selectorEventProc;
            }
         }
         return var_927;
      }
      ...
      {
         return !!var_788 ? selector.iterator : null;
      }
