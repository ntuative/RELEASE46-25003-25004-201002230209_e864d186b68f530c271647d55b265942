package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_521:String = "none";
      ...
      private static function method_7(param1:TextController, param2:String) : void
      {
         var _loc5_:* = null;
         var _loc3_:TextFormat = param1.defaultTextFormat;
         _loc3_.font = param2;
      ...
      override public function dispose() : void
      {
         if(var_742)
         {
            context.removeLocalizationListener(var_313,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_313 = param1;
         if(var_313.charAt(0) == "$" && var_313.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_313.slice(2,var_313.indexOf("}")),this);
            var_742 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_888,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_352,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_352,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_610,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_610,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_521,PropertyStruct.STRING,var_521 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_610,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_521 = var_521;
         _loc1_.var_742 = var_742;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_521 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_521 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_521 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_521 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
