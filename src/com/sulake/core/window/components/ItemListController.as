package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1392:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1024:String = "scale_to_fit_items";
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_161 = var_741 || !testParamFlag(WindowParam.const_29);
         _container = _context.create("_CONTAINER","",WindowType.const_318,WindowStyle.const_332,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_327,containerEventHandler);
         _container.addEventListener(WindowEvent.const_419,containerEventHandler);
      ...
      {
         return new Rectangle(var_525 * maxScrollH,var_524 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_327,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_419,containerEventHandler);
         super.dispose();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1022,_spacing,PropertyStruct.const_63,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1023,var_745,PropertyStruct.const_55,var_745 != const_1391));
         _loc1_.push(new PropertyStruct(const_1024,var_523,PropertyStruct.const_55,var_523 != const_1392));
         _loc1_.push(new PropertyStruct(const_1025,var_1100,PropertyStruct.const_55,var_1100 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
