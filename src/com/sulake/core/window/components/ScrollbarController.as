package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1063:String = "increment";
      
      private static const const_484:String = "slider_bar";
      
      private static const const_1064:String = "decrement";
      
      private static const const_754:String = "slider_track";
      ...
      {
         return findChildByName(ScrollbarController.const_754) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_805 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_805 != null)
         {
            _loc1_ = findParentByName(var_805) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_805) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1063)
            {
               if(var_21)
               {
                  var_551 = true;
            ...
            else if(param2.name == ScrollbarController.const_1064)
            {
               if(var_21)
               {
                  var_551 = true;
            ...
            else if(param2.name == ScrollbarController.const_754)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_938)
         {
