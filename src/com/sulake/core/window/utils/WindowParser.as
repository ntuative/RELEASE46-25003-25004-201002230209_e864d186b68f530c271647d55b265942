package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1550:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1469:String = "_TEMP";
      
      private static const const_1123:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_931:Dictionary;
      
      protected var var_1368:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1101,var_1102);
         var_931 = new Dictionary();
         var_1367 = new Dictionary();
         ParamCodeTable.fillTables(var_931,var_1367);
         var_1368 = new Map();
      }
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1123,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_931)
            {
               delete var_931[_loc1_];
            }
            for(_loc1_ in var_1367)
            {
               delete var_1367[_loc1_];
            }
            var_1368.dispose();
            var_1368 = null;
            _context = null;
