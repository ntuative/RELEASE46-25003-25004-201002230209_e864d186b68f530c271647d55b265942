package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_414:int = -2147483648;
      
      private var var_416:int = 2147483647;
      ...
      {
         return var_415 == int.MIN_VALUE && var_416 == int.MAX_VALUE && var_414 == int.MIN_VALUE && var_413 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_416 = param1;
         if(var_416 < int.MAX_VALUE && true && _target.width > var_416)
         {
            _target.width = var_416;
         }
      }
      ...
      {
         var_414 = param1;
         if(var_414 > int.MIN_VALUE && true && _target.height < var_414)
         {
            _target.height = var_414;
         }
      }
