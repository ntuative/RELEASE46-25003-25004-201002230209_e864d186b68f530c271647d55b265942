package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      {
         return var_694.getTheActualState(param1.type,param1.style,param1.state) != var_1035;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_776) : uint(const_493);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_695) ? uint(const_777) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_777)
               {
                  ...
                  if(var_225)
                  {
                     ...
                     _loc6_.draw(param1,var_94,var_94.rect,var_695,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_29))
                  {
                     ...
                     _loc4_.draw(var_94,var_922,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc2_ = var_694.getSkinRendererByType(param1.type,WindowStyle.const_817);
            }
         }
         return _loc2_;
      }
