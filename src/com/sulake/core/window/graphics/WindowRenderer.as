package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_569 = new Array();
         var_1494 = new Point();
         var_1495 = new Rectangle();
         var_302 = new Rectangle();
         var_301 = new Dictionary(true);
         var_694 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_301[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_302.x = _loc3_.dirty.x;
               var_302.y = _loc3_.dirty.y;
               var_302.width = _loc3_.dirty.width;
               var_302.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_302);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_565,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_301[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1494,var_1495))
            {
               if(param2.render(param1,var_1494,var_1495))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_301[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_565,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_302.x = param2.x - param1.x;
            var_302.y = param2.y - param1.y;
            var_302.width = param2.width;
            var_302.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_29))
            {
               while(param1.testParamFlag(WindowParam.const_29))
               {
                  ...
                  var_302.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_302,WindowRedrawFlag.const_234);
