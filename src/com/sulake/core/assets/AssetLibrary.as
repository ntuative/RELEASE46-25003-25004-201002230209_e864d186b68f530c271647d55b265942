package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_901:String = "AssetLibraryReady";
      
      public static const const_1350:String = "AssetLibraryUnloaded";
      
      public static const const_433:String = "AssetLibraryLoaded";
      
      public static const const_1373:String = "AssetLibraryLoadError";
       
      
      private var var_446:XML;
      ...
      private var var_374:Dictionary;
      ...
      private var var_447:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_541;
         var_373 = new Dictionary(false);
         var_374 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_373)
         {
            _loc4_ = AssetTypeDeclaration(var_373[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_374)
         {
            _loc2_ = var_374[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_374[_loc1_];
         }
         ...
         var_288 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1350));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_446 = _loc2_.manifest.copy();
         var_328 = _loc2_.resource;
         if(var_447)
         {
            AssetLibrary.fetchLibraryContents(this,var_446,var_328);
         }
         var_288 = true;
         dispatchEvent(new Event(AssetLibrary.const_433));
         dispatchEvent(new Event(AssetLibrary.const_901));
         if(var_447)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_374[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_942,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_374[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_373.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_373[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      {
         return param1 < var_329.length ? getAssetByName(var_329[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1373));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_373)
         {
            _loc3_ = AssetTypeDeclaration(var_373[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_634[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_446.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_374[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_329.splice(var_329.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_373[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
