package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      public function HabboMain(param1:DisplayObjectContainer)
      {
         ...
         var_1.addEventListener(ProgressEvent.PROGRESS,method_8);
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            var_31.error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,Core.const_992);
      ...
      private function method_8(param1:ProgressEvent) : void
      {
      ...
      private function initializeCore() : void
      {
         ...
         {
            trackLoginStep(Habbo.const_23);
            Core.crash("Failed to initialize the core: " + error.message,Core.const_902,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            trackLoginStep(Habbo.const_23);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_902,error);
            Core.dispose();
         }
      }
      ...
      private function dispose() : void
      {
         ...
         if(var_1)
         {
            ...
            var_1.removeEventListener(ProgressEvent.PROGRESS,method_8);
            var_1 = null;
         }
         if(parent)
         {
