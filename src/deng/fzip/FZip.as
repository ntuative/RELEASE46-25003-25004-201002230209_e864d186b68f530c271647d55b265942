package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_570))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_570,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_92 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_570,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_457.parse(param1))
         {
            ...
            if(false)
            {
               var_127["null"] = var_457;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1144,var_457));
            var_457 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_44 != null && var_127 != null && param1 < var_44.length)
         {
